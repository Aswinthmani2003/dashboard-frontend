...
def get_css(theme):
    if theme == "dark":
        ...
        <style>
            ...
            .sender-badge.chatbot {
                background-color: #00a884;
                color: #111b21;
            }
            
            .sender-badge.dashboard {
...
with col2:
    ...
    if not conv:
        ...
        for msg in conv:
            ...
            # Determine if it's from chatbot or dashboard user
            sender_type = ""
            sender_badge = ""
            if direction == "bot":
                handled_by = msg.get("handled_by", "")
                if handled_by and "Dashboard" in handled_by:
                    sender_type = "dashboard"
                    sender_badge = '<div class="sender-badge dashboard">📱 Dashboard User</div>'
                else:
                    sender_type = "chatbot"
                    sender_badge = '<div class="sender-badge chatbot">🤖 Chatbot</div>'
