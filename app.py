...
if not conv:
    ...
    for msg in conv:
        ...
        # Message direction - incoming from user (left), outgoing from bot (right)
        if msg["direction"] in ["user", "incoming"]:
            direction = "incoming"  # Left side - from client
        else:
            direction = "outgoing"  # Right side - from you/bot
